...
function SajuProcessingContent() {
  ...
  return (
    <div className="min-h-screen overflow-hidden p-6 text-center" style={{ background: '#FBF7F2' }}>
      <div className="flex min-h-screen flex-col items-center justify-center">
        <div className="relative mb-12">
          ...
          {isCompatibility
            ...
            : <Moon className="absolute -right-6 -top-6 h-12 w-12 animate-bounce" style={{ fill: '#d4688a', color: '#d4688a' }} />
          }
        </div>
    ...
    <>
      <div className="mt-8 flex justify-center">
        <button
          ...
          style={{
            background: 'linear-gradient(135deg, #d4688a, #c2255c)',
  ...
  return (
    <Suspense fallback={
      <div className="flex justify-center py-12">
        <Loader2 className="h-8 w-8 animate-spin" style={{ color: '#d4688a' }} />
      </div>
    }>
      <SajuEntryContent />
    </Suspense>
