...
export default function SajuPreview({ name = '홍길동', gender = '남', birthDate = '1995.01.01', pillars }: SajuPreviewProps) {
  return (
    <div className="w-full max-w-md mx-auto space-y-6 pb-24 px-4">
      {/* 상단: 결제 유도 섹션 */}
      <div className="bg-[#3C1E1E] rounded-[2.5rem] p-8 text-center shadow-xl relative overflow-hidden mt-8">
        <div className="absolute top-0 right-0 w-32 h-32 bg-[#FEE500]/10 rounded-full -mr-16 -mt-16 blur-3xl" />
        
        <div className="space-y-4 relative z-10">
          <div className="flex items-center justify-center gap-2 text-[#FEE500] mb-2">
            <Zap className="w-5 h-5 fill-[#FEE500]" />
          ...
          <h2 className="text-white text-2xl font-black break-keep">
            운명의 치트키를 <br/> <span className="text-[#FEE500]">로그인 없이 바로</span> 확인하세요!
          </h2>

          <div className="flex items-center justify-center gap-4 py-2">
            <div className="bg-white/10 px-4 py-2 rounded-2xl">
              <p className="text-gray-400 text-[10px] font-bold">현재 포인트</p>
              <p className="text-white font-black">0 P</p>
            </div>
            <div className="text-[#FEE500] font-black">/</div>
            <div className="bg-white/10 px-4 py-2 rounded-2xl">
              <p className="text-gray-400 text-[10px] font-bold">필요 포인트</p>
              <p className="text-[#FEE500] font-black">1 P</p>
            </div>
          </div>
      ...
      <div className="bg-white rounded-[3rem] p-8 shadow-sm border border-gray-100 space-y-8 relative overflow-hidden">
        ...
        <div className="space-y-1">
          <h3 className="text-xl font-black text-[#3C1E1E]">나의 운명 데이터</h3>
