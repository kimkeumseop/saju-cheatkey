    ...
    <main className="relative min-h-screen overflow-x-hidden pt-24 pb-32" style={{ background: '#FBF7F2' }}>
      ...
      <article className="relative z-10 px-6 py-6 max-w-4xl mx-auto space-y-8">
        <header className="rounded-[3rem] p-8 md:p-12 space-y-4" style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(212,104,138,0.14)', boxShadow: '0 8px 40px rgba(212,104,138,0.06)' }}>
          <p className="text-xs font-black tracking-[0.25em] uppercase" style={{ color: 'rgba(212,104,138,0.7)' }}>Privacy Policy</p>
          <h1 className="text-3xl md:text-4xl font-bold" style={{ color: '#2D1B1E', fontFamily: '"Noto Serif KR", serif' }}>개인정보처리방침</h1>
          <p className="text-sm" style={{ color: 'rgba(45,27,30,0.42)' }}>최종 수정일: 2026년 3월 13일</p>
        ...
        <div className="space-y-5 leading-8" style={{ color: 'rgba(45,27,30,0.62)' }}>
          <section className="rounded-[2rem] p-6 md:p-8 space-y-4" style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(212,104,138,0.12)' }}>
            <h2 className="text-xl font-bold text-[#2D1B1E]">1. 수집 항목 및 이용 목적</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-4" style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(212,104,138,0.12)' }}>
            <h2 className="text-xl font-bold text-[#2D1B1E]">2. 광고 및 쿠키 안내</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-4" style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(212,104,138,0.12)' }}>
            <h2 className="text-xl font-bold text-[#2D1B1E]">3. 보관 및 외부 제공</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-4" style={{ background: 'rgba(255,255,255,0.92)', border: '1px solid rgba(212,104,138,0.12)' }}>
            <h2 className="text-xl font-bold text-[#2D1B1E]">4. 이용자 권리 및 문의처</h2>
            <p>
            ...
            <div className="flex flex-wrap gap-3 text-sm font-bold">
              ...
              <Link href="/terms" className="px-4 py-2 rounded-full transition-colors" style={{ background: 'rgba(212,104,138,0.1)', border: '1px solid rgba(212,104,138,0.2)', color: '#d4688a' }}>
                이용약관
              </Link>
