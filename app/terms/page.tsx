...
export default function TermsPage() {
  return (
    <main className="relative min-h-screen overflow-x-hidden pt-24 pb-32 px-4 md:px-6" style={{ background: '#0d0710' }}>
      <CosmicBackground />
      <Navbar dark />
      ...
      <article className="relative z-10 max-w-4xl mx-auto space-y-8">
        <header className="rounded-[3rem] p-8 md:p-12 space-y-4" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(232,130,154,0.14)', boxShadow: '0 8px 40px rgba(232,130,154,0.06)' }}>
          <p className="text-xs font-black tracking-[0.25em] uppercase" style={{ color: 'rgba(232,130,154,0.7)' }}>Terms of Service</p>
          <h1 className="text-3xl font-bold" style={{ color: '#f5eef2', fontFamily: '"Noto Serif KR", serif' }}>이용약관</h1>
        ...
        <section className="space-y-5 leading-8" style={{ color: 'rgba(240,232,238,0.62)' }}>
          <section className="rounded-[2rem] p-6 md:p-8 space-y-3" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(232,130,154,0.12)' }}>
            <h2 className="text-xl font-bold text-[#f5eef2]">제 1 조 (목적)</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-3" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(232,130,154,0.12)' }}>
            <h2 className="text-xl font-bold text-[#f5eef2]">제 2 조 (서비스의 내용)</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-3" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(232,130,154,0.12)' }}>
            <h2 className="text-xl font-bold text-[#f5eef2]">제 3 조 (이용자의 의무)</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-3" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(232,130,154,0.12)' }}>
            <h2 className="text-xl font-bold text-[#f5eef2]">제 4 조 (책임의 한계)</h2>
            <p>
          ...
          <section className="rounded-[2rem] p-6 md:p-8 space-y-3" style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(232,130,154,0.12)' }}>
            <h2 className="text-xl font-bold text-[#f5eef2]">제 5 조 (개인정보보호 및 문의)</h2>
            <p>
              회사는 개인정보처리방침을 통해 개인정보 처리 기준을 안내합니다. 이용약관이나 서비스 이용과 관련한 문의는 {SITE_EMAIL} 로 접수할 수 있습니다.
            </p>
            <div className="flex flex-wrap gap-3 text-sm font-bold">
              <Link href="/privacy" className="px-4 py-2 rounded-full transition-colors" style={{ background: 'rgba(232,130,154,0.1)', border: '1px solid rgba(232,130,154,0.2)', color: '#e8829a' }}>
                개인정보처리방침
              </Link>
        ...
        <div className="p-6 rounded-2xl text-sm" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', color: 'rgba(240,232,238,0.42)' }}>
