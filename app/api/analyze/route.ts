...
export async function POST(req: Request) {
  try {
    ...
    [결과 구성]
    결과는 반드시 아래 8가지 섹션으로 나누고, 각 섹션의 소제목은 '팩폭기', '겉바속촉', '프로 N잡러', '강강약약', '숨은 필살기', '인간관계 스캐너', '럭키비키 모먼트', '존버 가이드' 같은 유행어를 섞어 후킹하게 뽑으세요.
    ...
    [
      ...
      { "title": "소제목6", "content": "상세 내용6" },
      { "title": "소제목7", "content": "상세 내용7" },
      { "title": "소제목8", "content": "상세 내용8" }
    ]
